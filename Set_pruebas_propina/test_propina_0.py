...
def test_orden_para_llevar_propina_0():
    pos = setup_and_login("Orden para llevar propina 0")
    if pos:
        try:
            exito = True
            ...
            if pos.agregar_producto("ruby", "Primer producto.png"):
                ...
                if pos.pagar_con_tarjeta("0 de propina.png"):
                    if pos.pagar_con_efectivo("14000", "0"):
                        if exito:
            ...
            if exito:
                assert True, "El escenario de Orden para llevar propina 0 finalizó con éxito."
