...
def test_cliente_fe_identificado():
    pos = setup_and_login(f"Orden con registro de nuevo cliente: {NOMBRE}")
    ...
    if pos:
        try:
            ...
            if pos.agregar_producto_modificador("producto 4", "Segundo producto.png"): 
                ...
                if exito: exito = pos.pagar_consumidor_identificado("5 de propina.png", DOCUMENTO, NOMBRE, CORREO)
                ...
                if exito:
                    assert True, "El escenario de Orden con registro de nuevo cliente fe finalizó con éxito."
